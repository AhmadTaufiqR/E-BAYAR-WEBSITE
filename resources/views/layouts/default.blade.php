...
<head>
	...
	<!-- nalika Icon CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/nalika-icon.css">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/owl.carousel.css">
    <link rel="stylesheet" href="assets/dashBoard/css/owl.theme.css">
    <link rel="stylesheet" href="assets/dashBoard/css/owl.transitions.css">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/animate.css">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/normalize.css">
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/meanmenu.min.css">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/main.css">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/morrisassets/dashBoard/js/morris.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/metisMenu/metisMenu.min.css">
    <link rel="stylesheet" href="assets/dashBoard/css/metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="assets/dashBoard/css/calendar/fullcalendar.min.css">
    <link rel="stylesheet" href="assets/dashBoard/css/calendar/fullcalendar.print.min.css">
    <!-- style CSS
		============================================ -->
    ...
    <!-- modernizr JS
		============================================ -->
    <script src="assets/dashBoard/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
    ...
    <!-- jquery
		============================================ -->
    <script src="assets/dashBoard/js/vendor/jquery-1.12.4.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="assets/dashBoard/js/jquery-price-slider.js"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="assets/dashBoard/js/jquery.meanmenu.js"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="assets/dashBoard/js/owl.carousel.min.js"></script>
    <!-- sticky JS
		============================================ -->
    <script src="assets/dashBoard/js/jquery.sticky.js"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="assets/dashBoard/js/jquery.scrollUp.min.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="assets/dashBoard/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="assets/dashBoard/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="assets/dashBoard/js/metisMenu/metisMenu.min.js"></script>
    <script src="assets/dashBoard/js/metisMenu/metisMenu-active.js"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="assets/dashBoard/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="assets/dashBoard/js/sparkline/jquery.charts-sparkline.js"></script>
    <!-- calendar JS
		============================================ -->
    <script src="assets/dashBoard/js/calendar/moment.min.js"></script>
    <script src="assets/dashBoard/js/calendar/fullcalendar.min.js"></script>
    <script src="assets/dashBoard/js/calendar/fullcalendar-active.js"></script>
	<!-- float JS
		============================================ -->
    <script src="assets/dashBoard/js/flot/jquery.flot.js"></script>
    <script src="assets/dashBoard/js/flot/jquery.flot.resize.js"></script>
    <script src="assets/dashBoard/js/flot/curvedLines.js"></script>
    <script src="assets/dashBoard/js/flot/flot-active.js"></script>
    <!-- plugins JS
		============================================ -->
